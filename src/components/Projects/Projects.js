...
const projects = [
  ...
  },
  {
    ...
    description: `
      Our Handmade Things Website lets users explore and select products with ease. Built with React and Material UI, it integrates with WhatsApp API for a simple, interactive way to finalize and share their selections.`,
  ...
  },
  {
    ...
    title: "Photography",
    description: `
      Our Photography Website showcases stunning visuals with a sleek, modern design. Built using HTML, CSS, JavaScript, and Tailwind CSS, it provides an engaging, responsive experience for browsing and enjoying photographs.`,
